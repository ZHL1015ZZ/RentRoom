        ...
        <div class="container text-center">
            <div class="jumbotron">
                ...
                <div class="contents clearfix">
                    <p style="font-size: 20px;">满足您的多样化需求<br>
                      		  找到适合您居住的“家”</p>
                </div>
                <a class="btn btn-warning btn-lg btn-3d" data-hover="立即咨询" href="#" role="button">立即咨询</a>
...
<header class="section-header home-section-header text-center">
    <div class="container">
        <h2 class="wow slideInRight">为您推荐</h2>
        <p class="wow slideInLeft">纵览小区，恋上这座城</p>
    </div>
</header>
    <div class="container">
        <div class="row">
    ...
    <figure class="feature-image">
        ...
        <a href="login-user.html"><span class="btn btn-warning btn-sale">立 即 收 藏</span></a>
    </figure>
...
<section id="home-property-for-rent-listing">
    <header class="section-header home-section-header text-center">
        <div class="container">
            <h2 class="wow slideInLeft">高档别墅</h2>
            <p class="wow slideInRight">独门独院，上有独立空间，下有私家花园领地</p>
        </div>
    </header>
    <div class="container">
        <div class="row">
