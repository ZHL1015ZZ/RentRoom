	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("[]")
				$("button[name='tijiao']").hide();
				$("button[name='chongzhi']").hide();
			});
			...
			<form id="addForm" class="layui-form" action="">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input value="1"  type="text" name="empId" required lay-verify="required|ZHCheck" placeholder="只允许输入中文" autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input value="业务员"  type="text" name="grade" required lay-verify="required|ZHCheck" placeholder="只允许输入中文" autocomplete="off" class="layui-input">
					</div>
            		<i class="iconfont icon-huaban bt"></i>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" value="2019-10-21" name="title" autocomplete="off" class="layui-input">
					</div>
				</div>	
				<div class="layui-form-item">
					<label class="layui-form-label">状态</label>
					<div class="layui-input-inline shortInput">
						<input type="text" value="离职" name="title" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
